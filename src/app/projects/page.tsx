                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity focus:opacity-100">
                      <Button
                        ...
                        className="text-gray-400 hover:text-primary-accent p-1 rounded h-auto w-auto bg-transparent"
                      >
                      ...
                      <Button
                        ...
                        className="text-gray-400 hover:text-red-500 p-1 rounded h-auto w-auto bg-transparent"
                      >
